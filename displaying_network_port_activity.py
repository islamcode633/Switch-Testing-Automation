...
def checking_presence_argument() -> str:
    ...
    try:
        ...
        try:
            ...
            raise ModuleNotFoundError('Module [ data ] was not found in the catalog !') from mod_err
        except ImportError as imp_err:
            raise ImportError('Name IPV4_SWITCH not found in module [ data ] !') from imp_err
